...
`;class Ot extends m{render(){return this.element=h.htmlToElement(Te,[],Se),this.element}}u(Ot,"componentName","logo");const Ce="_logout_yeasz_1",$e={logout:Ce},Le=`<div class='logout'>\r
...
</div>`;class Pt extends m{constructor({router:e}){super(),this.store=v.getInstance(),this.user=this.store.state.user,this.router=e}render(){return this.element=h.htmlToElement(Le,[],$e),i(this.element).find("button").click(()=>{this.store.logout(),this.router.navigate("./auth")}),this.element}}u(Pt,"componentName","logoutbutton");const Ae="_notification_1ykxd_1",ke="_slideIn_1ykxd_1",Ie="_error_1ykxd_14",Ne="_success_1ykxd_14",ut={notification:Ae,slideIn:ke,error:Ie,success:Ne};var $,J,Rt;class H{constructor(){d(this,J);d(this,$);x(this,$,null)}show(e,t){if(!["success","error"].includes(e))throw new Error('Invalid notification type. Allowed types are "success" and "error".');const n={success:ut.success,error:ut.error},r=i("#notification"),o=n[e];r.text(t).addClass(o),c(this,J,Rt).call(this,()=>{r.removeClass(o)},3e3)}}$=new WeakMap,J=new WeakSet,Rt=function(e,t){l(this,$)&&clearTimeout(l(this,$)),x(this,$,setTimeout(e,t))};const Me={error:"rgb(255 74 74 / 61%)"};class ze{constructor(){this.errorBorderTimeout={}}showError(e,t=2500){e.css("border-color",Me.error),this.errorBorderTimeout[e]&&clearTimeout(this.errorBorderTimeout[e]),this.errorBorderTimeout[e]=setTimeout(()=>{e.css("border-color","")},t)}}const W=new ze,Oe="_button_5jjbu_1",Pe="_green_5jjbu_18",Re="_purple_5jjbu_24",xt={button:Oe,green:Pe,purple:Re},Be=`<button class='button'></button>\r
`;class P extends m{constructor({children:e,onClick:t,variant:n}){if(super(),!e)throw new Error("Children is empty!");this.children=e,this.onClick=t,this.variant=n}render(){return this.element=h.htmlToElement(Be,[],xt),i(this.element).html(this.children).click(this.onClick),this.variant&&i(this.element).addClass(xt[this.variant]),this.element}}u(P,"componentName","button");const Ue="_field_1y2ef_1",De={field:Ue},je=`<label class='field'>\r
	<input />\r
</label>\r
`;class R extends m{constructor({placeholder:e,type:t="text",value:n="",name:r,variant:o}){if(super(),!r)throw new Error('Please fill field parameter "name"!');this.placeholder=e,this.type=t,this.value=n,this.name=r,this.variant=o}render(){this.element=h.htmlToElement(je,[],De);const e=i(this.element).find("input").input({placeholder:this.placeholder,type:this.type,value:this.value,name:this.name});return this.type==="number"&&e.numberInput(),this.variant==="credit-card"&&e.creditCardInput(),this.element}}u(R,"componentName","field");const He="http://localhost:4200";function St(s){return typeof s.message=="object"?s.message[0]:s.message}async function L({path:s,body:e=null,headers:t={},method:n="GET",onError:r=null,onSuccess:o=null}){let a=!0,f=null,g=null;const w=`${He}/api${s}`,T=new Mt().getItem(mt),_={method:n,headers:{"Content-Type":"application/json",...t}};T&&(_.headers.Authorization=`Bearer ${T}`),e&&(_.body=JSON.stringify(e));try{const C=await fetch(w,_);if(C.ok)g=await C.json(),o&&o(g);else{const A=await C.json(),O=St(A);r&&(console.log(O),r(O)),new H().show("error",O)}}catch(C){const A=St(C);r&&(console.log(A),r(A))}finally{a=!1}return{isLoading:a,error:f,data:g}}var k;class gt{constructor(){d(this,k,"/cards");this.store=v.getInstance().state,this.notificationService=new H}byUser(e){return L({path:`${l(this,k)}/by-user`,onSuccess:e})}updateBalance(e,t,n){return L({path:`${l(this,k)}/balance/${t}`,method:"PATCH",body:{amount:+e},onSuccess:()=>{this.notificationService.show("success","Balance successfully changed!"),n()}})}transfer({amount:e,toCardNumber:t},n){return L({path:`${l(this,k)}/transfer-money`,method:"PATCH",body:{amount:+e,fromCardNumber:this.store.user.card.number,toCardNumber:t},onSuccess:()=>{this.notificationService.show("success","Transfer successfully completed!"),n()}})}}k=new WeakMap;const qe={"transfer-field":"_transfer-field_lzd97_1"},Fe=`<div class='transfer-field'>
	<component-field></component-field>
	<component-button></component-button>
</div>`,Y="balanceUpdated",B="transactionCompleted",Bt='[name="card-number"]';class Ut extends m{constructor(){super();u(this,"handleTransfer",t=>{t.preventDefault(),this.store.user||this.notificationService.show("error","You need authorization!"),i(t.target).text("Sending...").attr("disabled",!0);const n=i(this.element).find("input"),r=n.value().replaceAll("-",""),o=()=>{i(t.target).removeAttr("disabled").text("Send"),n.value("")};if(!r){W.showError(i(this.element).find("label")),o();return}let a=prompt("Transfer amount");this.cardService.transfer({amount:a,toCardNumber:r},()=>{n.value(""),a="",document.dispatchEvent(new Event(B)),document.dispatchEvent(new Event(Y))}),o()});this.store=v.getInstance().state,this.cardService=new gt,this.notificationService=new H}render(){return this.element=h.htmlToElement(Fe,[new R({name:"card-number",placeholder:"xxxx-xxxx-xxxx-xxxx",variant:"credit-card"}),new P({children:"Send",variant:"purple",onClick:this.handleTransfer})],qe),this.store.user||i(this.element).find("input").attr("disabled",!0),this.element}}u(Ut,"componentName","transferfield");function Ve(s,e){let t;return function(...n){const r=()=>{clearTimeout(t),s.apply(this,n)};clearTimeout(t),t=setTimeout(r,e)}}var X;class Dt{constructor(){d(this,X,"/users")}getAll(e,t){return L({path:`${l(this,X)}${e?`?${new URLSearchParams({searchTerm:e})}`:""}`,onSuccess:t})}}X=new WeakMap;const We="_search_ibd97_1",Ye="_results_ibd97_19",Ge="_showIn_ibd97_1",Ke="_item_ibd97_32",Je="_visible_ibd97_37",dt={search:We,results:Ye,showIn:Ge,item:Ke,visible:Je},Xe=`<div class='search'>\r
	<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor'>\r
...
`;var Q;class jt extends m{constructor(){super();d(this,Q,async t=>{const n=t.target.value,r=i(this.element).find("#search-results");if(!n){r.html("");return}await this.userService.getAll(n,o=>{r.html(""),o.forEach((a,f)=>{const g=new it(a,!0,()=>{i(Bt).value(vt(a.card.number)),r.html("")}).render();i(g).addClass(dt.item).css("transition-delay",`${f*.1}s`),r.append(g),setTimeout(()=>{i(g).addClass(dt.visible)},50)})})});this.userService=new Dt}render(){this.element=h.htmlToElement(Xe,[],dt);const t=Ve(l(this,Q),300);return i(this.element).find("input").input({type:"search",name:"search",placeholder:"Search contacts..."}).on("input",t),this.element}}Q=new WeakMap,u(jt,"componentName","search");class Qe extends m{constructor({router:e}){super(),this.store=v.getInstance(),this.store.addObserver(this),this.router=e,this.userItem=new it({avatarPath:"./",name:"User"})}update(){this.user=this.store.state.user;const e=i(this.element).find("#auth-side");this.user?(e.show(),this.userItem.update(this.user),this.router.navigate("./")):e.hide()}render(){return this.element=h.htmlToElement(_e,[Ot,new Pt({router:this.router}),jt,this.userItem],Ee),this.update(),this.element}}const Ze=`<section class='layout'>\r
	<main>\r
		<component-notification></component-notification>\r
		<div id='content'></div>\r
	</main>\r
</section>\r
`,tn="<div class='notification' id='notification'></div>";class Ht extends m{render(){return this.element=h.htmlToElement(tn,[],ut),this.element}}u(Ht,"componentName","notification");class en extends m{constructor({router:e,children:t}){super(),this.router=e,this.children=t}render(){this.element=h.htmlToElement(Ze,[Ht],ge);const e=i(this.element).find("main"),t=i(this.element).find("#content");return t.append(this.children),e.before(new Qe({router:this.router}).render()).append(t.element),this.element}}const Tt="Obsidian Bank",nn=s=>s?`${s} | ${Tt}`:Tt;class ot{constructor({title:e}){document.title=nn(e)}render(){throw new Error("Render method must be implemented in the child class")}}class sn extends ot{constructor(){super({title:"Not Found"})}render(){return"<p>Not Found</p>"}}class rn extends ot{constructor(){super({title:"About"})}render(){return"<p>About</p>"}}class on{getFormValues(e){const t=e.querySelectorAll("input"),n={};for(const r of t)n[r.name]=r.value;return n}}const an=new on;var Z;class cn{constructor(){d(this,Z,"/auth");this.store=v.getInstance(),this.notificationService=new H}main(e,t){return L({path:`${l(this,Z)}/${e}`,body:t,onSuccess:n=>{this.store.login(n.user,n.accessToken),this.notificationService.show("success","You have successfully logged in !")},method:"POST"})}}Z=new WeakMap;const ln="_auth_ya0cv_1",dn={auth:ln},hn=`<div class='auth'>
	<form>
		<h1>Sign in</h1>
...
</div>`;class Jt extends m{constructor(){super(),this.store=v.getInstance().state,this.userService=new Dt}fetchData(){this.userService.getAll(null,e=>{if(e){this.element.querySelector(wt).remove();for(const t of e)i(this.element).find("#contacts-list").append(new it(t,!0,()=>{i(Bt).value(vt(t.card.number))}).render());i(this.element).find("#contacts-list").findAll("button").forEach(t=>{t.addClass("fade-in")})}})}render(){return this.element=h.htmlToElement(An,[Ut,new ct("Transfer money")],Ln),this.store.user&&(i(this.element).find("#contacts-list").html(new at().render().outerHTML),setTimeout(()=>this.fetchData(),500)),this.element}}u(Jt,"componentName","contacts");const kn=`<div class='home'>\r
	<div>\r
...
`;var st;class In{constructor(){d(this,st,"/statistics")}main(e){return L({path:l(this,st),onSuccess:e})}}st=new WeakMap;const Nn="_statistics_1t05k_1",Mn={statistics:Nn},zn="_draw_1pw7d_1",On="_fadeIn_1pw7d_1",Pn={"donut-chart":"_donut-chart_1pw7d_1",draw:zn,fadeIn:On},Rn=`<div class='donut-chart'>

</div>`;var p,Qt,pt,Zt,te,ee,ne,se;class Xt extends m{constructor(t,n={size:250,donutWidth:50}){super();d(this,p);u(this,"gap",15);this.data=t,this.size=n.size,this.donutWidth=n.donutWidth}render(){return this.element=h.htmlToElement(Rn,[],Pn),i(this.element).append(c(this,p,se).call(this)),this.element}}p=new WeakSet,Qt=function(){return this.data.reduce((t,n)=>t+n.value,0)},pt=function(t,n){const o=(t*3.6-90)*Math.PI/180,a=n*Math.cos(o),f=n*Math.sin(o);return[a,f]},Zt=function(){const t=document.createElementNS("http://www.w3.org/2000/svg","svg");return t.setAttribute("width",this.size),t.setAttribute("height",this.size),t.setAttribute("viewBox",`-5 -5 ${this.size+this.gap} ${this.size+this.gap}`),t},te=function(){const t=document.createElementNS("http://www.w3.org/2000/svg","g");return t.setAttribute("transform",`translate(${this.size/2+this.gap/4}, ${this.size/2+this.gap/4})`),t},ee=function(t,n){if(!n||n.includes("NaN"))return;const r=document.createElementNS("http://www.w3.org/2000/svg","path");return r.setAttribute("d",n),r.setAttribute("fill","none"),r.setAttribute("stroke",t.color),r.setAttribute("stroke-width",this.donutWidth),r},ne=function(t){const n=c(this,p,Qt).call(this),r=.8,o=this.size*r,a=o/2;let f=0;this.data.forEach(g=>{const w=g.value/n*100,[T,_]=c(this,p,pt).call(this,f,a);f+=w;const[C,A]=c(this,p,pt).call(this,f,a),O=w>50?1:0,me=`M ${T} ${_} A ${a} ${a} 0 ${O} 1 ${C} ${A}`,bt=c(this,p,ee).call(this,g,me);bt.classList.add("rotate"),t.appendChild(bt)})},se=function(){const t=c(this,p,Zt).call(this),n=c(this,p,te).call(this);return c(this,p,ne).call(this,n),t.appendChild(n),t},u(Xt,"componentName","donutchart");const Bn={"circle-chart":"_circle-chart_1k8h1_1"},Un=`<div class='circle-chart'>
	<component-donut-chart></component-donut-chart>
</div>`;class Dn extends m{constructor(e,t){super(),this.incomePercent=e,this.expensePercent=t}render(){return this.element=h.htmlToElement(Un,[new Xt([{value:this.incomePercent,color:"#08f0c8"},{value:this.expensePercent,color:"#917cff"}])],Bn),this.element}}const jn="_green_1slco_25",Hn="_purple_1slco_31",Lt={"statistic-item":"_statistic-item_1slco_1",green:jn,purple:Hn},qn=`<div class='statistic-item'>
	<span id='statistic-label'></span>
	<span id='statistic-value'></span>
</div>`;class At extends m{constructor(e,t,n){if(super(),!e||!t||!n)throw new Error("Label, value and variant (purple/green) required!");this.label=e,this.value=t,this.variant=n}render(){return this.element=h.htmlToElement(qn,[],Lt),i(this.element).addClass(Lt[this.variant]).addClass("fade-in"),i(this.element).find("#statistic-label").text(this.label),i(this.element).find("#statistic-value").text(this.value),this.element}}const Fn=`<div class='statistics'>
	<component-heading></component-heading>
...
</div>`;class Qn extends m{constructor(e){super(),this.transaction=e}render(){this.element=h.htmlToElement(Xn,[],kt);const e=this.transaction.type==="TOP_UP",t=e?"Income":"Expense";return e&&i(this.element).addClass(kt.income),i(this.element).find("#transaction-name").text(t),i(this.element).find("#transaction-date").text(Gn(this.transaction.createdAt)),i(this.element).find("#transaction-amount").text(G(this.transaction.amount)),this.element}}const Zn=`<section class='transactions'>
	<component-heading></component-heading>
	<div id='transactions-list'></div>
</section>`;var z,ce,le,D;class ae extends m{constructor(){super();d(this,z);d(this,D,()=>{this.fetchData()});this.store=v.getInstance().state,this.transactionService=new Vn,this.element=h.htmlToElement(Zn,[new ct("Recent transactions")],Yn),c(this,z,ce).call(this)}destroy(){c(this,z,le).call(this)}fetchData(){this.transactionService.getAll(t=>{if(!t)return;const n=this.element.querySelector(wt);n&&n.remove();const r=i(this.element).find("#transactions-list");if(r.text(""),t.length)for(const o of t.transactions)r.append(new Qn(o).render());else r.text("Transactions not found!")})}render(){return this.store.user&&(i(this.element).append(new at().render()),setTimeout(()=>this.fetchData(),500)),this.element}}z=new WeakSet,ce=function(){document.addEventListener(B,l(this,D))},le=function(){document.removeEventListener(B,l(this,D))},D=new WeakMap,u(ae,"componentName","transactions");class ts extends ot{constructor(){super({title:"Home"}),this.store=v.getInstance(),this.store.addObserver(this),this.components={cardInfo:null,transactions:null,statistics:null}}createOrUpdateComponent(e,t){return this.components[t]&&this.components[t].destroy(),this.components[t]=new e,this.components[t]}update(){this.user=this.store.state.user,this.user||i(this.element).html(new fn().render().outerHTML)}render(){const e=[this.createOrUpdateComponent(Vt,"cardInfo"),this.createOrUpdateComponent(ae,"transactions"),this.createOrUpdateComponent(re,"statistics"),Ft,Jt];return this.element=h.htmlToElement(kn,e,gn),this.update(),this.element}}const es=[{path:"./",component:ts},{path:"./auth",component:mn},{path:"./about",component:rn}];var j,I,N,b,de,F,he;class ns{constructor(){d(this,b);d(this,j);d(this,I);d(this,N,null);x(this,j,es),x(this,I,null),c(this,b,F).call(this),c(this,b,de).call(this),window.addEventListener("popstate",()=>{c(this,b,F).call(this)})}getCurrentPath(){return window.location.pathname.replace("/bank-js-intensive/","./")}navigate(e){e!==this.getCurrentPath()&&(window.history.pushState({},"",e),c(this,b,F).call(this))}}j=new WeakMap,I=new WeakMap,N=new WeakMap,b=new WeakSet,de=function(){document.addEventListener("click",e=>{const t=e.target.closest("a");t&&(e.preventDefault(),this.navigate(t.href))})},F=function(){const e=this.getCurrentPath();let t=l(this,j).find(n=>n.path===e);t||(t={component:sn}),x(this,I,t),c(this,b,he).call(this)},he=function(){const e=new(l(this,I)).component().render();l(this,N)?i("#content").html("").append(e):(x(this,N,new en({router:this,children:e}).render()),i("#app").append(l(this,N)))};new ns;
