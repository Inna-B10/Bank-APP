...
`,me="_logo_efu2a_1",ue={logo:me},pe=`<nav class='logo'>
	<a href='./' title='Home'> Obsidian Bank </a>
</nav>
`;class fe extends m{render(){return this.element=h.htmlToElement(pe,[],ue),this.element}}const ve="_logout_yeasz_1",ge={logout:ve},we=`<div class='logout'>
	<button title='Logout'>
...
`;class F extends m{constructor({children:e,onClick:t,variant:n}){if(super(),!e)throw new Error("Children is empty!");this.children=e,this.onClick=t,this.variant=n}render(){return this.element=h.htmlToElement(Le,[],xt),i(this.element).html(this.children).click(this.onClick),this.variant&&i(this.element).addClass(xt[this.variant]),this.element}}const Ie="_field_1y2ef_1",ke={field:Ie},Me=`<label class='field'>
	<input />
</label>
