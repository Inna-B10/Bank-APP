...
</div>`;class be extends m{constructor({router:e}){super(),this.store=p.getInstance(),this.user=this.store.state.user,this.router=e}render(){return this.element=h.htmlToElement(we,[],ge),i(this.element).find("button").click(()=>{this.store.logout(),this.router.navigate("./auth")}),this.element}}const ye="_notification_1ykxd_1",Ee="_slideIn_1ykxd_1",_e="_error_1ykxd_14",xe="_success_1ykxd_14",ht={notification:ye,slideIn:Ee,error:_e,success:xe};var S,K,Bt;class U{constructor(){d(this,K);d(this,S);E(this,S,null)}show(e,t){if(!["success","error"].includes(e))throw new Error('Invalid notification type. Allowed types are "success" and "error".');const n={success:ht.success,error:ht.error},r=i("#notification"),o=n[e];r.text(t).addClass(o),c(this,K,Bt).call(this,()=>{r.removeClass(o)},3e3)}}S=new WeakMap,K=new WeakSet,Bt=function(e,t){l(this,S)&&clearTimeout(l(this,S)),E(this,S,setTimeout(e,t))};const Se={error:"rgb(255 74 74 / 61%)"};class Te{constructor(){this.errorBorderTimeout={}}showError(e,t=2500){e.css("border-color",Se.error),this.errorBorderTimeout[e]&&clearTimeout(this.errorBorderTimeout[e]),this.errorBorderTimeout[e]=setTimeout(()=>{e.css("border-color","")},t)}}const q=new Te,Ce="_button_5jjbu_1",$e="_green_5jjbu_18",Le="_purple_5jjbu_24",xt={button:Ce,green:$e,purple:Le},Ae=`<button class='button'></button>\r
`;class F extends m{constructor({children:e,onClick:t,variant:n}){if(super(),!e)throw new Error("Children is empty!");this.children=e,this.onClick=t,this.variant=n}render(){return this.element=h.htmlToElement(Ae,[],xt),i(this.element).html(this.children).click(this.onClick),this.variant&&i(this.element).addClass(xt[this.variant]),this.element}}const Ie="_field_1y2ef_1",ke={field:Ie},Me=`<label class='field'>\r
	<input />\r
</label>\r
`;class V extends m{constructor({placeholder:e,type:t="text",value:n="",name:r,variant:o}){if(super(),!r)throw new Error('Please fill field parameter "name"!');this.placeholder=e,this.type=t,this.value=n,this.name=r,this.variant=o}render(){this.element=h.htmlToElement(Me,[],ke);const e=i(this.element).find("input").input({placeholder:this.placeholder,type:this.type,value:this.value,name:this.name});return this.type==="number"&&e.numberInput(),this.variant==="credit-card"&&e.creditCardInput(),this.element}}const ze="http://localhost:4200";function St(s){return typeof s.message=="object"?s.message[0]:s.message}async function T({path:s,body:e=null,headers:t={},method:n="GET",onError:r=null,onSuccess:o=null}){let a=!0,f=null,v=null;const g=`${ze}/api${s}`,M=new zt().getItem(dt),z={method:n,headers:{"Content-Type":"application/json",...t}};M&&(z.headers.Authorization=`Bearer ${M}`),e&&(z.body=JSON.stringify(e));try{const x=await fetch(g,z);if(x.ok)v=await x.json(),o&&o(v);else{const C=await x.json(),O=St(C);r&&(console.log(O),r(O)),new U().show("error",O)}}catch(x){const C=St(x);r&&(console.log(C),r(C))}finally{a=!1}return{isLoading:a,error:f,data:v}}var $;class vt{constructor(){d(this,$,"/cards");this.store=p.getInstance().state,this.notificationService=new U}byUser(e){return T({path:`${l(this,$)}/by-user`,onSuccess:e})}updateBalance(e,t,n){return T({path:`${l(this,$)}/balance/${t}`,method:"PATCH",body:{amount:+e},onSuccess:()=>{this.notificationService.show("success","Balance successfully changed!"),n()}})}transfer({amount:e,toCardNumber:t},n){return T({path:`${l(this,$)}/transfer-money`,method:"PATCH",body:{amount:+e,fromCardNumber:this.store.user.card.number,toCardNumber:t},onSuccess:()=>{this.notificationService.show("success","Transfer successfully completed!"),n()}})}}$=new WeakMap;const Oe={"transfer-field":"_transfer-field_lzd97_1"},Be=`<div class='transfer-field'>
	<component-field></component-field>
	<component-button></component-button>
</div>`,W="balanceUpdated",B="transactionCompleted",Nt='[name="card-number"]';class Ne extends m{constructor(){super();ot(this,"handleTransfer",t=>{t.preventDefault(),this.store.user||this.notificationService.show("error","You need authorization!"),i(t.target).text("Sending...").attr("disabled",!0);const n=i(this.element).find("input"),r=n.value().replaceAll("-",""),o=()=>{i(t.target).removeAttr("disabled").text("Send"),n.value("")};if(!r){q.showError(i(this.element).find("label")),o();return}let a=prompt("Transfer amount");this.cardService.transfer({amount:a,toCardNumber:r},()=>{n.value(""),a="",document.dispatchEvent(new Event(B)),document.dispatchEvent(new Event(W))}),o()});this.store=p.getInstance().state,this.cardService=new vt,this.notificationService=new U}render(){return this.element=h.htmlToElement(Be,[new V({name:"card-number",placeholder:"xxxx-xxxx-xxxx-xxxx",variant:"credit-card"}),new F({children:"Send",variant:"purple",onClick:this.handleTransfer})],Oe),this.store.user||i(this.element).find("input").attr("disabled",!0),this.element}}function Pe(s,e){let t;return function(...n){const r=()=>{clearTimeout(t),s.apply(this,n)};clearTimeout(t),t=setTimeout(r,e)}}var J;class Pt{constructor(){d(this,J,"/users")}getAll(e,t){return T({path:`${l(this,J)}${e?`?${new URLSearchParams({searchTerm:e})}`:""}`,onSuccess:t})}}J=new WeakMap;const Re="_search_ibd97_1",Ue="_results_ibd97_19",De="_showIn_ibd97_1",je="_item_ibd97_32",He="_visible_ibd97_37",ct={search:Re,results:Ue,showIn:De,item:je,visible:He},qe=`<div class='search'>\r
	<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor'>\r
...
</div>`;class Cn extends m{constructor(){super(),this.store=p.getInstance().state,this.userService=new Pt}fetchData(){this.userService.getAll(null,e=>{if(e){this.element.querySelector(gt).remove();for(const t of e)i(this.element).find("#contacts-list").append(new ft(t,!0,()=>{i(Nt).value(pt(t.card.number))}).render());i(this.element).find("#contacts-list").findAll("button").forEach(t=>{t.addClass("fade-in")})}})}render(){return this.element=h.htmlToElement(Tn,[Ne,new wt("Transfer money")],Sn),this.store.user&&(i(this.element).find("#contacts-list").html(new it().render().outerHTML),setTimeout(()=>this.fetchData(),500)),this.element}}const $n=`<div class='home'>\r
	<div>\r
...
`;var nt;class Ln{constructor(){d(this,nt,"/statistics")}main(e){return T({path:l(this,nt),onSuccess:e})}}nt=new WeakMap;const An="_statistics_1t05k_1",In={statistics:An},kn="_draw_1pw7d_1",Mn="_fadeIn_1pw7d_1",zn={"donut-chart":"_donut-chart_1pw7d_1",draw:kn,fadeIn:Mn},On=`<div class='donut-chart'>

</div>`;var u,qt,mt,Ft,Vt,Wt,Yt,Gt;class Bn extends m{constructor(t,n={size:250,donutWidth:50}){super();d(this,u);ot(this,"gap",15);this.data=t,this.size=n.size,this.donutWidth=n.donutWidth}render(){return this.element=h.htmlToElement(On,[],zn),i(this.element).append(c(this,u,Gt).call(this)),this.element}}u=new WeakSet,qt=function(){return this.data.reduce((t,n)=>t+n.value,0)},mt=function(t,n){const o=(t*3.6-90)*Math.PI/180,a=n*Math.cos(o),f=n*Math.sin(o);return[a,f]},Ft=function(){const t=document.createElementNS("http://www.w3.org/2000/svg","svg");return t.setAttribute("width",this.size),t.setAttribute("height",this.size),t.setAttribute("viewBox",`-5 -5 ${this.size+this.gap} ${this.size+this.gap}`),t},Vt=function(){const t=document.createElementNS("http://www.w3.org/2000/svg","g");return t.setAttribute("transform",`translate(${this.size/2+this.gap/4}, ${this.size/2+this.gap/4})`),t},Wt=function(t,n){if(!n||n.includes("NaN"))return;const r=document.createElementNS("http://www.w3.org/2000/svg","path");return r.setAttribute("d",n),r.setAttribute("fill","none"),r.setAttribute("stroke",t.color),r.setAttribute("stroke-width",this.donutWidth),r},Yt=function(t){const n=c(this,u,qt).call(this),r=.8,o=this.size*r,a=o/2;let f=0;this.data.forEach(v=>{const g=v.value/n*100,[M,z]=c(this,u,mt).call(this,f,a);f+=g;const[x,C]=c(this,u,mt).call(this,f,a),O=g>50?1:0,ee=`M ${M} ${z} A ${a} ${a} 0 ${O} 1 ${x} ${C}`,bt=c(this,u,Wt).call(this,v,ee);bt.classList.add("rotate"),t.appendChild(bt)})},Gt=function(){const t=c(this,u,Ft).call(this),n=c(this,u,Vt).call(this);return c(this,u,Yt).call(this,n),t.appendChild(n),t};const Nn={"circle-chart":"_circle-chart_1k8h1_1"},Pn=`<div class='circle-chart'>
	<component-donut-chart></component-donut-chart>
</div>`;class Rn extends m{constructor(e,t){super(),this.incomePercent=e,this.expensePercent=t}render(){return this.element=h.htmlToElement(Pn,[new Bn([{value:this.incomePercent,color:"#08f0c8"},{value:this.expensePercent,color:"#917cff"}])],Nn),this.element}}const Un="_green_1slco_25",Dn="_purple_1slco_31",Lt={"statistic-item":"_statistic-item_1slco_1",green:Un,purple:Dn},jn=`<div class='statistic-item'>
	<span id='statistic-label'></span>
	<span id='statistic-value'></span>
</div>`;class At extends m{constructor(e,t,n){if(super(),!e||!t||!n)throw new Error("Label, value and variant (purple/green) required!");this.label=e,this.value=t,this.variant=n}render(){return this.element=h.htmlToElement(jn,[],Lt),i(this.element).addClass(Lt[this.variant]).addClass("fade-in"),i(this.element).find("#statistic-label").text(this.label),i(this.element).find("#statistic-value").text(this.value),this.element}}const Hn=`<div class='statistics'>
	<component-heading></component-heading>
...
</div>`;var y,Kt,Jt,ut;class qn extends m{constructor(){super();d(this,y);this.store=p.getInstance().state,this.statisticService=new Ln,this.element=h.htmlToElement(Hn,[new wt("Statistics")],In),c(this,y,Kt).call(this)}destroy(){c(this,y,Jt).call(this)}renderChart(t,n){const r=t+n;let o=t*100/r,a=100-o;return t&&!n&&(o=100,a=.1),!t&&n&&(o=.1,a=100),new Rn(o,a).render()}fetchData(){this.statisticService.main(t=>{if(!t)return;const n=this.element.querySelector(gt);n&&n.remove();const r=i(this.element).find("#statistics-items");r.text("");const o=i(this.element).find("#circle-chart");o.text(""),r.append(new At("Income:",Y(t[0].value),"green").render()).append(new At("Expense:",Y(t[1].value),"purple").render()),o.append(this.renderChart(t[0].value,t[1].value))})}render(){return this.store.user&&(i(this.element).append(new it().render()),setTimeout(()=>this.fetchData(),500)),this.element}}y=new WeakSet,Kt=function(){document.addEventListener(B,c(this,y,ut).bind(this))},Jt=function(){document.removeEventListener(B,c(this,y,ut).bind(this))},ut=function(){this.fetchData()};var st;class Fn{constructor(){d(this,st,"/transactions")}getAll(e){return T({path:l(this,st)+`?${new URLSearchParams({orderBy:"desc"})}`,onSuccess:e})}}st=new WeakMap;const Vn="_transactions_vmmkx_1",Wn={transactions:Vn};function Yn(s){const e=new Date(s),t={month:"short",day:"numeric",year:"numeric"};return e.toLocaleDateString("en-US",t)}const Gn="_slideIn_z2q3q_1",Kn="_income_z2q3q_21",It={"transaction-item":"_transaction-item_z2q3q_1",slideIn:Gn,income:Kn},Jn=`<div class='transaction-item'>\r
	<div>\r
		<div>\r
...
</section>`;var k,Xt,Qt,P;class Zn extends m{constructor(){super();d(this,k);d(this,P,()=>{this.fetchData()});this.store=p.getInstance().state,this.transactionService=new Fn,this.element=h.htmlToElement(Qn,[new wt("Recent transactions")],Wn),c(this,k,Xt).call(this)}destroy(){c(this,k,Qt).call(this)}fetchData(){this.transactionService.getAll(t=>{if(!t)return;const n=this.element.querySelector(gt);n&&n.remove();const r=i(this.element).find("#transactions-list");if(r.text(""),t.length)for(const o of t.transactions)r.append(new Xn(o).render());else r.text("Transactions not found!")})}render(){return this.store.user&&(i(this.element).append(new it().render()),setTimeout(()=>this.fetchData(),500)),this.element}}k=new WeakSet,Xt=function(){document.addEventListener(B,l(this,P))},Qt=function(){document.removeEventListener(B,l(this,P))},P=new WeakMap;class ts extends rt{constructor(){super({title:"Home"}),this.store=p.getInstance(),this.store.addObserver(this),this.components={cardInfo:null,transactions:null,statistics:null}}createOrUpdateComponent(e,t){return this.components[t]&&this.components[t].destroy(),this.components[t]=new e,this.components[t]}update(){this.user=this.store.state.user,this.user||i(this.element).html(new ln().render().outerHTML)}render(){const e=[this.createOrUpdateComponent(bn,"cardInfo"),this.createOrUpdateComponent(Zn,"transactions"),this.createOrUpdateComponent(qn,"statistics"),fn,Cn];return this.element=h.htmlToElement($n,e,hn),this.update(),this.element}}const es=[{path:"./",component:ts},{path:"./auth",component:on},{path:"./about",component:Qe}];var R,L,A,w,Zt,j,te;class ns{constructor(){d(this,w);d(this,R);d(this,L);d(this,A,null);E(this,R,es),E(this,L,null),c(this,w,j).call(this),c(this,w,Zt).call(this),window.addEventListener("popstate",()=>{c(this,w,j).call(this)})}getCurrentPath(){return window.location.pathname.replace("/bank-js-intensive/","./")}navigate(e){e!==this.getCurrentPath()&&(window.history.pushState({},"",e),c(this,w,j).call(this))}}R=new WeakMap,L=new WeakMap,A=new WeakMap,w=new WeakSet,Zt=function(){document.addEventListener("click",e=>{const t=e.target.closest("a");t&&(e.preventDefault(),this.navigate(t.href))})},j=function(){const e=this.getCurrentPath();let t=l(this,R).find(n=>n.path===e);t||(t={component:Xe}),E(this,L,t),c(this,w,te).call(this)},te=function(){const e=new(l(this,L)).component().render();l(this,A)?i("#content").html("").append(e):(E(this,A,new Ke({router:this,children:e}).render()),i("#app").append(l(this,A)))};new ns;
