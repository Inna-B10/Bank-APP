...
</div>`;class Pt extends m{constructor({router:e}){super(),this.store=v.getInstance(),this.user=this.store.state.user,this.router=e}render(){return this.element=h.htmlToElement(Le,[],$e),i(this.element).find("button").click(()=>{this.store.logout(),this.router.navigate("./auth")}),this.element}}u(Pt,"componentName","logoutbutton");const Ae="_notification_1ykxd_1",Ie="_slideIn_1ykxd_1",ke="_error_1ykxd_14",Ne="_success_1ykxd_14",ut={notification:Ae,slideIn:Ie,error:ke,success:Ne};var C,J,Rt;class H{constructor(){d(this,J);d(this,C);x(this,C,null)}show(e,t){if(!["success","error"].includes(e))throw new Error('Invalid notification type. Allowed types are "success" and "error".');const n={success:ut.success,error:ut.error},r=i("#notification"),o=n[e];r.text(t).addClass(o),c(this,J,Rt).call(this,()=>{r.removeClass(o)},3e3)}}C=new WeakMap,J=new WeakSet,Rt=function(e,t){l(this,C)&&clearTimeout(l(this,C)),x(this,C,setTimeout(e,t))};const Me={error:"rgb(255 74 74 / 61%)"};class ze{constructor(){this.errorBorderTimeout={}}showError(e,t=2500){e.css("border-color",Me.error),this.errorBorderTimeout[e]&&clearTimeout(this.errorBorderTimeout[e]),this.errorBorderTimeout[e]=setTimeout(()=>{e.css("border-color","")},t)}}const W=new ze,Oe="_button_5jjbu_1",Pe="_green_5jjbu_18",Re="_purple_5jjbu_24",xt={button:Oe,green:Pe,purple:Re},Be=`<button class='button'></button>\r
